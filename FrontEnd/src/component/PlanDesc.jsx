...
const PlanDesc = () => {
 ...
 const [fade, setFade] = useState(true);
  ...
  return (
    <div className="max-w-screen min-h-screen bg-[url('/background-design.png')] bg-cover bg-no-repeat bg-center px-6 py-6  flex flex-col items-center space-y-2 justify-center">
