...
const Interests = () => {
    ...
    return (<>
      <div className="border-gray-300 shadow-xl border mt-2 flex flex-col gap-6 p-4   rounded-lg shadow-md w-full  mx-auto bg-gradient-to-br  from-[lightgoldenrodyellow] to-[palegoldenrod]">
        ...
        <ul
          ...
          className={`cursor-pointer px-4 py-2  rounded-md text-md font-bold transition-all duration-300 border ${
            selectedInterests.includes(int)
              ? "bg-orange-500 text-green-700  shadow-sm shadow-green-500"
              : "bg-gray-200 text-red-700 shadow-sm shadow-red-500"
          }`}
